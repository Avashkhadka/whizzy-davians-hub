            ...
            <div className="min-h-screen py-20">
                <div className="container mx-auto px-4">
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
                        ...
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Relive the excitement and joy from our past events through these captured moments.</p>
                    </motion.div>

                    {/* Gallery Grid */}
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }} className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
