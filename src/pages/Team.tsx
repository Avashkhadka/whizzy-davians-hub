        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              The passionate individuals who make Whizzy Davians what it is today.
            </p>
          </motion.div>
          ...
          >
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Whizzy Davians was founded with a simple yet powerful mission: to create a space where 
                students can grow beyond the classroom. We believe in the power of experiences – whether 
                it's the thrill of competition, the joy of creative expression, or the satisfaction of 
                community service. Our team works tirelessly to organize events that inspire, challenge, 
                and bring students together. We're more than a club; we're a family of dreamers, doers, 
                and changemakers.
              </p>
            </div>
          </motion.section>
          ...
          >
            ...
            <p className="text-muted-foreground text-center mb-8 max-w-2xl mx-auto">
              Honoring those who laid the foundation and shaped our club's legacy.
            </p>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {alumni.map((member, index) => (
                ...
                >
                  <div className="bg-card rounded-2xl border border-border p-6 text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1 opacity-90 hover:opacity-100">
                    ...
                    {member.batch && (
                      <p className="text-xs text-muted-foreground">Batch: {member.batch}</p>
                    )}
                    {member.contribution && (
